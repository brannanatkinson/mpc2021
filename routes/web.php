...
use App\Http\Livewire\Catalog\CatalogItem;
...
Route::get('/hosts', Hosts::class)->middleware(['auth:sanctum', 'verified']);
Route::get('/items', Items::class)->middleware(['auth:sanctum', 'verified']);
